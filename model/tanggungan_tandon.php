...
class tanggungan_tandon
{

    public function get_tanggungan_tandon($no_mhs = 0, $start = null, $length = null,  $search = null)
    {
        global $mysqli;
    ...
    public function get_total_tanggungan_tandon($no_mhs)
    {
        global $mysqli;
        $query_total = "SELECT count(judul) as jumlah FROM tandon";
        // jika pencarian berjalan
