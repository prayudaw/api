...
class transaksi
{
   ...
   public function get_transaksi_skripsi($no_mhs = 0, $start = null, $length = null,  $search = null)
   {
      global $mysqli;
   ...
   public function get_transaksi_tandon($no_mhs = 0, $start = null, $length = null,  $search = null)
   {
      global $mysqli;
      $query = "SELECT * FROM tandon";
      $search_query = "";
      // jika pencarian berjalan
      if ($search != null) {
   ...
   public function get_total_tandon($no_mhs)
   {
      global $mysqli;
      $query_total = "SELECT count(judul) as jumlah FROM tandon";
      // jika pencarian berjalan
      if ($no_mhs != 0) {
         $query_total .= " WHERE nim='" . $no_mhs . "'";
      }
